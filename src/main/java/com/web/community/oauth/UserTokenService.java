...
public class UserTokenService extends UserInfoTokenServices {
    public UserTokenService(ClientResources resources, SocialType socialType) {
        ...
        setAuthoritiesExtractor(new OAuth2AuthoritiesExtrator(socialType));
    }

    public static class OAuth2AuthoritiesExtrator implements AuthoritiesExtractor {

        private String socialType;

        public OAuth2AuthoritiesExtrator(SocialType socialType) {
